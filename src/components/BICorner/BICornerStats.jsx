...
/**
 * BICornerStats Component
 * 
 * KPI Cards for BI Corner visits - Aligned with Audiovisual style
 */
...
function BICornerStats({ stats, todayVisits = 0 }) {
    ...
    const kpis = [
        {
            id: 'bi-today',
            icon: Users,
            label: 'Kunjungan BI Corner Hari Ini',
            value: todayVisits,
            subLabel: 'pengunjung',
        },
        {
