...
/**
 * KarelTable Component
 * 
 * Table untuk log kunjungan Ruang Karel dengan fitur:
 * - Sortable columns
 * - Search filter
 * - Export to Excel
 */

function KarelTable({ visits = [], loading = false, title = "Log Kunjungan Ruang Karel" }) {
    ...
    const handleExport = () => {
        ...
        exportToExcel(data, 'Kunjungan_Ruang_Karel', 'Karel');
    };
