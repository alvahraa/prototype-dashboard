...
/**
 * ReferensiChart Component
 * 
 * Bar chart showing referensi visits distribution by faculty
 */
...
function ReferensiChart({ data = [], title = 'Distribusi Kunjungan per Fakultas' }) {
