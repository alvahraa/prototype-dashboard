...
/**
 * ReferensiTable Component
 * 
 * Table untuk log kunjungan ruangan referensi dengan fitur:
 * - Sortable columns
 * - Search filter
 * - Export to Excel
 */

function ReferensiTable({ visits = [], loading = false, title = "Log Kunjungan Ruangan Referensi" }) {
    ...
    // Export handler - includes Umur and Jurusan
    const handleExport = () => {
        ...
        exportToExcel(data, 'Kunjungan_Ruangan_Referensi', 'Referensi');
    };
                        ...
                        {processedData.length === 0 ? (
                            ...
                            processedData.map((visit, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-gray-500 dark:text-slate-400 font-mono text-xs">{visit.nim}</td>
                                    <td className="px-4 py-3 text-sm text-gray-600 dark:text-slate-300">{visit.umur || '-'}</td>
