...
/**
 * SirkulasiTable Component
 * 
 * Table untuk log kunjungan sirkulasi dengan fitur:
 * - Sortable columns
 * - Search filter
 * - Export to Excel
 */

function SirkulasiTable({ visits = [], loading = false, title = "Log Kunjungan", floor = 1 }) {
    ...
    const handleExport = () => {
        ...
        exportToExcel(data, `Kunjungan_Sirkulasi_Lantai_${floor}`, `Sirkulasi_Lt${floor}`);
    };
