...
/**
 * SmartLabTable Component
 * 
 * Table untuk log kunjungan SmartLab dengan fitur:
 * - Sortable columns
 * - Search filter
 * - Export to Excel
 */

function SmartLabTable({ visits = [], loading = false, title = "Log Kunjungan SmartLab" }) {
    ...
    const handleExport = () => {
        ...
        exportToExcel(data, 'Kunjungan_SmartLab', 'SmartLab');
    };
